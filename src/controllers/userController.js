...
import { isBootstrapAdminEmail, provisionFirebaseUser, requiresVerifiedFirebaseEmail } from "../services/bootstrapAdmins.js";
...
export const loginUser = async (req, res) => {
  try {
    ...
    if (requiresVerifiedFirebaseEmail(user) && !req.firebaseUser.email_verified) {
      return res.status(403).send({
